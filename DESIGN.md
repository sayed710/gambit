...
- **Glacial Cyan** (#0b5e6d / #7fdce8): accent text on paper — italic hero emphasis, ledger titles on hover.
...
### Named Rules
**The One Accent Rule.** The teal accent marks interaction and live state — never large surfaces, never text that isn't actionable.
**The Polar Rule.** Backgrounds are ice-white or polar-night blue-black; pure white and pure black never appear.
...
### Board
Glacier palette default (#dce9f2 / #5d84a0 light, #43596e / #22334a dark) with frost, polar, walnut, tundra and aurora alternatives per theme. Last-move squares get brass at 45% alpha; selection gets brass at 60% + inset ring; check is a red radial under the king. Legal-move hints are radial dots, tinted from the square's own ink, toggleable.
